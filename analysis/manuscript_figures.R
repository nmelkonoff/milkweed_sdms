...
#simplying polygons ##getting error here
...
fig_1_a <- ggplot(data = subulata_inset, aes(x = year, y = max_lat, size = n)) +
  ...
  labs (x = "Year", y = "Maximum Latitude (º)") +
  geom_vline(xintercept = 2000, lty = 2) +
  annotate(geom = "text", label = "Timeframe Break Point", x = 1960, y = 47.5) +
  theme(axis.title = element_text(size = 18),
        legend.position = "top")

#trying a different type of plot
# ggplot(data = c(monarch, subulata), aes(monarch$date, subulata$date, fill = Species) +
...
ggsave(plot = fig_1, filename = "./output/fig_1_NM.png", width = 16, height = 8.5, units = "in")
...
fig_2 = ggarrange(fig_2_a, fig_2_b, nrow = 2, align = "hv", 
                  heights = c(1.25, 1))
ggsave(plot = fig_2, filename = "./output/fig_2_NM.png", device = "png",
...
ggsave(plot = maxent_raw_hp_1, filename = "./output/hostplant_1_maxent_raw_NM.png", device = "png")
...
ggsave(plot = maxent_raw_hp_2, filename = "./output/hostplant_2_maxent_raw_NM.png", device = "png")
...
ggsave(plot = maxent_raw_hp_3, filename = "./output/hostplant_3_maxent_raw_NM.png", device = "png")
...
ggsave(plot = fig_3, filename = "./output/fig_3_NM.png", device = "png",
...
ggsave(plot = histograms_plot, filename = "./output/fig_4_NM.png", device = "png",
...
ggsave(plot = fig_5, filename = "./output/fig_5_NM.png", device = "png", 
